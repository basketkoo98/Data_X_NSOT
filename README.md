...
Link to our Dashboard: https://share.streamlit.io/basketkoo98/NSOT-NBA-Salary-Optimization-Project/gui/NSOT_gui.py
...
Our Python and R modeling files are used to find predicted salary of NBA players in the future and these value are automatically displayed on our Streamlit Dashboard, since all the codes interacts without any crashing and successfully update the player data we provide. 
